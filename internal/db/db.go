...
func (s *Store) ListSubordinatesBySupervisor(ctx context.Context, supervisor string, limit int) ([]AppUserRecord, error) {
	key := strings.TrimSpace(supervisor)
	if key == "" {
		return []AppUserRecord{}, nil
	}
	if limit <= 0 {
		limit = 2000
	}
